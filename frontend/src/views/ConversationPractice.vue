...
<template>
    <div>
        <ConversationSetupPanel
            ...
            :is-custom-topic-selected="isCustomTopicSelected"
        ...
        <ConversationScenarioStep
            v-if="phase === 'scenario'"
            :selected-language-label="selectedLanguageLabel"
            :selected-difficulty="selectedDifficulty"
            :error="store.error"
            :show-transcription-confirm="showTranscriptionConfirm"
            :transcribed-text="transcribedText"
            :speech-supported="speechSupported"
            :is-recording="isRecording"
            :user-input="userInput"
            :loading="store.loading"
            @confirm-transcription="confirmTranscription"
            @edit-transcription="editTranscription"
            @cancel-transcription="cancelTranscription"
            @toggle-recording="isRecording ? stopRecording() : startRecording()"
            @update:user-input="userInput = $event"
            @submit="submitScenarioTopic"
            @back="phase = 'setup'; userInput = ''; store.error = null"
        />

        <ConversationChatStep
            v-if="phase === 'chat'"
            ...
            :speaking-message-idx="speakingMessageIdx"
            :context="store.context"
            :messages="store.messages"
            :sending-message="store.sendingMessage"
            :hint="hint"
            :inactivity-hint="inactivityHint"
            :error="store.error"
            :show-transcription-confirm="showTranscriptionConfirm"
            :transcribed-text="transcribedText"
            :conversation-ended="conversationEnded"
            :loading-feedback="store.loadingFeedback"
            :show-translations="showTranslations"
            :speech-supported="speechSupported"
            :is-recording="isRecording"
            :user-input="userInput"
            @toggle-auto-speak="autoSpeak = !autoSpeak; if (!autoSpeak) stopSpeaking()"
        ...
        <ConversationFeedbackStep
            v-if="phase === 'feedback' && store.feedback"
            ...
            :feedback-category-label="feedbackCategoryLabel"
            :creating-deck="creatingDeck"
            :deck-created="deckCreated"
            :deck-create-error="deckCreateError"
            @create-deck="createFlashcardsFromConversation"
            @try-again="tryAgain"
            @new-topic="startNewConversation"
            @home="router.push('/')"
        />
    </div>
</template>
